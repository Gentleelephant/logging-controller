...
import (
	...
	"github.com/Gentleelephant/logging-controller/internal/controller"
	//+kubebuilder:scaffold:imports
)

var (
	sourcePort string // received log from vector
	cacheCh    = make(chan any, 10000)
)
...
func main() {
	...
	flag.StringVar(&sourcePort, "source-port", "9000", "receive log form vector")
	opts := zap.Options{
		Development: true,
	}
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "d6ee3693.birdhk.com",
	...
	// start server,receive log from vector
	go startServer()
